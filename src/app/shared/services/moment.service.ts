...
export class MomentService {
    ...
    getDayOfWeekNames(
        style: TranslationWidth = TranslationWidth.Narrow
    ): string[] {
    ...
    getMonthName(
        date: Moment,
        style: TranslationWidth = TranslationWidth.Abbreviated
    ): string {
